...
### i rely on  
[![My Skills](https://skillicons.dev/icons?i=html,css,boostraps,tailwind,js,ts,react,angular,nextjs,flutter,lua,python,mongodb,mysql,postgresql,git,github,docker,jenkins,figma,photoshop)](https://skillicons.dev)  
